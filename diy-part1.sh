...
git clone https://github.com/QiuSimons/openwrt-mos/trunk/mosdns package/new/mosdns
git clone https://github.com/QiuSimons/openwrt-mos/trunk/luci-app-mosdns package/new/luci-app-mosdns
